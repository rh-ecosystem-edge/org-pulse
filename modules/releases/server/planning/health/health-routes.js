...
function healthRoutes(router, context) {
  ...
  /**
   * @openapi
   * /api/modules/releases/planning/releases/{version}/health:
   *   get:
   *     summary: Get health data for a release version
   *     tags: [Releases - Planning Health]
   *     parameters:
   *       - in: path
   *         name: version
   *         required: true
   ...
   *     responses:
   *       200:
   *         description: Health data with feature assessments
   *       202:
   *         description: Health pipeline running, data not yet available
   *       400:
  ...
  /**
   * @openapi
   * /api/modules/releases/planning/releases/{version}/health/summary:
   *   get:
   *     summary: Get health summary for a release version
   *     tags: [Releases - Planning Health]
   *     parameters:
   *       - in: path
   *         name: version
   ...
   *     responses:
   *       200:
   *         description: Health summary with milestones
   *       404:
  ...
  /**
   * @openapi
   * /api/modules/releases/planning/releases/{version}/health/feature/{key}:
   *   get:
   *     summary: Get health detail for a single feature
   *     tags: [Releases - Planning Health]
   *     parameters:
   *       - in: path
   *         name: version
   ...
   *     responses:
   *       200:
   *         description: Feature health detail
   *       400:
   *         description: Invalid version, key, or phase
   *       404:
  ...
  /**
   * @openapi
   * /api/modules/releases/planning/releases/{version}/health/override/{featureKey}:
   *   put:
   *     summary: Set a risk override for a feature
   *     tags: [Releases - Planning Health]
   *     parameters:
   *       - in: path
   *         name: version
   ...
   * /api/modules/releases/planning/releases/{version}/health/override/{featureKey}:
   *   delete:
   *     summary: Remove a risk override for a feature
   *     tags: [Releases - Planning Health]
   *     parameters:
   *       - in: path
   *         name: version
  ...
  /**
   * @openapi
   * /api/modules/releases/planning/releases/{version}/health/snapshot/{phase}:
   *   get:
   *     summary: Get committed snapshot for a phase
   *     tags: [Releases - Planning Health]
   *     parameters:
   *       - in: path
   *         name: version
   ...
   *     responses:
   *       200:
   *         description: Committed snapshot data
   *       400:
   *         description: Invalid version or phase
   *       404:
   ...
   * /api/modules/releases/planning/releases/{version}/health/snapshot/{phase}:
   *   post:
   *     summary: Create a committed snapshot for a phase
   *     tags: [Releases - Planning Health]
   *     parameters:
   *       - in: path
   *         name: version
  ...
  /**
   * @openapi
   * /api/modules/releases/planning/releases/{version}/health/refresh:
   *   post:
   *     summary: Trigger health data refresh for a release version
   *     tags: [Releases - Planning Health]
   *     parameters:
   *       - in: path
   *         name: version
   ...
   *         description: Invalid version or phase
   *       429:
   *         description: Maximum concurrent refreshes reached
   */
  router.post('/releases/:version/health/refresh', requirePM, requireScope('releases:write'), function(req, res) {
    var version = req.params.version
    var phase = parsePhase(req)
    if (!isValidVersion(version)) {
      return res.status(400).json({ error: 'Invalid version format' })
  ...
  /**
   * @openapi
   * /api/modules/releases/planning/releases/{version}/health/refresh/status:
   *   get:
   *     summary: Get health refresh status for a release version
   *     tags: [Releases - Planning Health]
   *     parameters:
   *       - in: path
   *         name: version
   ...
   *         description: Invalid version or phase
   */
  router.get('/releases/:version/health/refresh/status', requireAuth, requireScope('releases:read'), function(req, res) {
    var version = req.params.version
    var phase = parsePhase(req)
    if (!isValidVersion(version)) {
      return res.status(400).json({ error: 'Invalid version format' })
  ...
  /**
   * @openapi
   * /api/modules/releases/planning/releases/health-admin/jira-fields:
   *   get:
   *     summary: Search Jira custom fields for RICE configuration
   *     tags: [Releases - Planning Health]
   *     parameters:
   *       - in: query
   *         name: query
   ...
   *     responses:
   *       200:
   *         description: Matching Jira fields
   *       400:
   *         description: Query too short
   */
  router.get('/releases/health-admin/jira-fields', requirePM, requireScope('releases:write'), async function(req, res) {
  ...
  /**
   * @openapi
   * /api/modules/releases/planning/releases/health-admin/config:
   *   put:
   *     summary: Save health admin configuration (RICE fields, etc.)
   *     tags: [Releases - Planning Health]
   *     responses:
   *       200:
  ...
  /**
   * @openapi
   * /api/modules/releases/planning/releases/health-admin/rice-test:
   *   post:
   *     summary: Test configured RICE field IDs against Jira
   *     tags: [Releases - Planning Health]
   *     responses:
   *       200:
   *         description: RICE field validation results
   *       400:
   ...
   * /api/modules/releases/planning/releases/health-admin/config:
   *   get:
   *     summary: Get health admin configuration
   *     tags: [Releases - Planning Health]
   *     responses:
   *       200:
  ...
  /**
   * @openapi
   * /api/modules/releases/planning/releases/{version}/health/milestones/debug:
   *   get:
   *     summary: Debug milestones data sources for a release version
   *     tags: [Releases - Planning Health]
   *     parameters:
   *       - in: path
   *         name: version
   ...
   *     responses:
   *       200:
   *         description: Debug milestones data
   *       400:
   *         description: Invalid version format
   */
  router.get('/releases/:version/health/milestones/debug', requirePM, requireScope('releases:write'), async function(req, res) {
    var version = req.params.version
    if (!isValidVersion(version)) {
      return res.status(400).json({ error: 'Invalid version format' })
    }
